...
func (pg *PostgresWorkoutStore) CreateWorkout(workout *Workout) (*Workout, error) {
	...
	query :=
		`
		INSERT INTO workouts (title, description, duration_seconds, calories_burned)
		VALUES ($1,$2,$3,$4)
		RETURNING id;
	`

	err = tx.QueryRow(query, workout.Title, workout.Description, workout.DurationSeconds, workout.CaloriesBurned).Scan(&workout.ID)
	if err != nil {
		return nil, err
	}
